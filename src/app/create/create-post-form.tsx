...
export default function CreatePostForm({
  ...
  return (
    <>
      <form
        className="border border-neutral-500 h-500 rounded-lg px-6 py-4 "
      ...
      >
        <div className="flex gap-4 items-start pb-4 w-full">
          ...
          <div className="flex flex-col gap-2 w-full ">
            ...
            <label className="w-full">
              <input
                className="bg-neutral-100 dark:bg-neutral-700 flex-1 border-none rounded w-full p-2 outline-none"
                type="text"
        ...
        <div className="flex justify-between items-center mt-5">
          ...
          <a href="/" className="text-neutral-500 hover:text-red-400 ">
            Cancel
          </a>
        ...
        {statusMessage && (
          <p className="bg-blue-200 border border-purple-600 text-purple-800 px-6 py-4 mb-6 rounded-lg shadow-md mt-4">
            {statusMessage}
          </p>
        )}
      </form>
